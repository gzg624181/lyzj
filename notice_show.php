...
<?php
$r=$dosql->GetOne("SELECT * from pmw_gonggao where id=$id");
 ?>
<div class="topheader clearfix"><a href="javascript:jeker.backurl();">返回 </a><h4><?php echo $r['title'];?></h4></div>
   <div class="play-introduce-wrap" style="background:white;height:auto">
      ...
      <p class="bottomcontent"><?php echo date("Y年m月d日 H:i",$r['issuetime']);?></p>
      <p class="bottomcontent"><?php echo $cfg_webname;?></p>
		 </ol>
	</div></div>
