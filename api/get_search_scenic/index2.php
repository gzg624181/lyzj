...
if(isset($token) && $token==$cfg_auth_key){
    ...
    if(isset($keyword)){
    $dosql->Execute("SELECT id,names,label,solds,types,flag,lowmoney,remarks,level,picarr,province,city,live_province,live_city FROM pmw_ticket where names like '%$keyword%' and  checkinfo=1 order by id desc ");
    ...
    $six=6;
    $dosql->Execute("SELECT * FROM pmw_ticket where checkinfo=1  and live_province='$live_province' and live_city='$live_city' order by rand() limit 4",$six);
