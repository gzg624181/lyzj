...
if($result===true){
    ...
    //将退款的状态更改掉
    $dosql->ExecNoneQuery("UPDATE pmw_order SET refund_state=1,refund_money='$refund_money',refund_nums=$refund_nums where orderid='$orderNo' and transaction_id='$wxOrderNo'");
    $gourl = "../../admin/success_states.php";
