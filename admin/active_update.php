...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
		  ...
		  <td colspan="4"><input type="text" name="active_name" id="active_name" class="input" value="<?php echo $row['active_name'];?>"/></td>
    </tr>
    <tr>
      <td height="40" align="right">活动开放头像：</td>
      <td colspan="4" valign="middle">
   <input style="margin-top:5px;" type="text" name="active_onimages" id="active_onimages" class="input"  value="<?php echo $row['active_onimages'];?>"/>
    ...
    <tr>
      ...
      <td colspan="4" valign="middle">
   <input style="margin-top:5px;" type="text" name="active_offimages" id="active_offimages" class="input" value="<?php echo $row['active_offimages'];?>" />
	  ...
	  <td height="40" align="right">是否在线：</td>
		  <td colspan="3"><p>
          <label>
		      <input type="radio" name="active_statues" value="1" <?php if($row['active_statues']==1){echo "checked='checked'";}?> id="active_statues" />
		      活动开放中</label>
          &nbsp;&nbsp;
		    <label>
		      <input name="active_statues" type="radio" id="active_statues" value="0" <?php if($row['active_statues']==0){echo "checked='checked'";}?> />
		      活动已结束</label><br />
	      </p></td>
      ...
      <tr>
		  ...
		  <td colspan="4"><textarea style="width:80%" name="active_description" id="active_description" class="kindeditor"><?php echo $row['active_description']; ?></textarea>
				<script>
				var editor;
      ...
      <tr>
        ...
        <td width="11%"><input type="text" name="orderid" id="orderid" class="inputos" value="<?php echo $row['orderid']; ?>" /></td>
      </tr>
      <tr>
