...
<body>
<div class="formHeader"> <span class="title">默认空白图片设置</span> <a href="javascript:location.reload();" class="reload"><?php echo $cfg_reload;?></a> </div>
<?php
...
<tr>
<td height="112" align="right">默认空白图片：</td>
<td width="9%" align="center"><img src="<?php echo $cfg_weburl."/".$r['imagesurl'];?>" width="100px;" style="border-radius:3px;margin-right:10px;"></td>
<td width="80%">
...
<span class="cnote"><span class="grayBtn" onclick="GetUploadify('uploadify','缩略图上传','image','image',1,20971520,'pic')">上 传</span></span>
    ...
    <input type="submit" class="submit" value="保存" />
		...
		<input type="hidden" name="action" id="action" value="default_update" />
   </div></td>
   </tr>
  </table>
