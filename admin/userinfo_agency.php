...
<div class="formHeader"> <span class="title">旅行注册会员社信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
    ...
    <tr>
		...
		<tr>
		  ...
		  <td><input name="company" type="text" class="input" id="company" value="<?php echo $row['company']; ?>" readonly  required="required" /></td>
	  </tr>
    <tr>
		  <td height="45" align="right">旅行社地址：</td>
		  <td><input name="address" type="text" class="input" id="address" value="<?php echo $row['address']; ?>" readonly  required="required" /></td>
	  </tr>
    ...
    <tr>
     ...
     <td>
       <p>
         <label>
        <input type="radio" name="checkinfo" value="0" <?php if($row['checkinfo']==0){echo "checked='checked'";} ?> id="checkinfo" />
        待审核</label>
         &nbsp;&nbsp;
           <label>
          ...
          审核通过</label>
           &nbsp;&nbsp;
        <label>
          <input type="radio" name="checkinfo" value="2" <?php if($row['checkinfo']==2){echo "checked='checked'";} ?> id="checkinfo" />
          审核失败</label><br />
        </p>
     </td>
    </tr>
    <tr>
     ...
     <td>
       <p>
           <label>
          <input type="radio" readonly name="forbiden" value="1" <?php if($row['forbiden']==1){echo "checked='checked'";} ?> id="forbiden" />
          通过</label>
           &nbsp;&nbsp;
        <label>
     ...
     <td>
       <p>
		...
		<tr>
			...
			<td><input readonly type="text" name="cardpicnumber" id="cardpicnumber" class="input" value="<?php echo $row['cardpicnumber']; ?>" /></td>
		</tr>
    <tr>
    ...
    <tr>
			...
			<td><input readonly type="text" name="regtime" id="regtime" class="input"  value="<?php echo date("Y-m-d H:i:s",$row['regtime']); ?>"  /></td>
		</tr>
	</table>
