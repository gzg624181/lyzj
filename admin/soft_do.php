...
?>
<div class="bottomToolbar"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:;" onclick="AjaxClearAll();">删除</a></span> <a href="<?php if($cid!=""){echo "soft_add.php?cid=".$cid;}else{echo "soft_add.php";}?>" class="dataBtn">添加软件信息</a></span> </div>
...
<div class="quickToolbar">
	<div class="qiuckWarp">
		<div class="quickArea"> <span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:;" onclick="AjaxClearAll();">删除</a></span> <a href="<?php if($cid!=""){echo "soft_add.php?cid=".$cid;}else{echo "soft_add.php";}?>" class="dataBtn">添加软件信息</a></span> <span class="pageSmall"><?php echo $dopage->AjaxPageSmall(); ?></span> </div>
