...
$tbname='pmw_agency';
?>
<div class="formHeader"> <span class="title" style="margin-left: 13px;">添加发布行程</span> <a href="javascript:location.reload();" class="reload"><i class="fa fa-refresh fa-spin fa-fw"></i></a> </div>
