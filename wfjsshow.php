...
<style type="text/css">
 ...
 .space20{height:8%;}
 .topheader{position:absolute;left:0;width:100%;padding:1rem;background:white;}
...
<?php
$r=$dosql->GetOne("SELECT game_name,game_description from `#@__gamedes` where id=$id");
 ?>
<div class="topheader clearfix" style="align:center;">

   <div class="play-introduce-wrap" style="background:white;height:auto">
   	<div class="play-introduce" style="margin-top:-0.8rem;">
		  <ol class="introduce-content" >
      <p><?php echo $r['game_description'];?></p>      <br><br>
		 </ol>
	</div></div>
